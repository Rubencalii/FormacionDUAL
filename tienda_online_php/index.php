        ...
        <aside>
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li>
                        <button id="Cuerda" class="boton-menu boton-categoria"><i class="bi bi-hand-index-thumb"></i> Cuerda</button>
                    </li>
                    <li>
                        <button id="Viento" class="boton-menu boton-categoria"><i class="bi bi-hand-index-thumb"></i> Viento</button>
                    </li>
                    <li>
